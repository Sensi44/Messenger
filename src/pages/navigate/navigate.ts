      ...
      <main class="navigatePage basePage">
        <nav>
          <ol class="navigatePage__list">
            ...
            <li class="navigatePage__element"><a href="#" data-page="messengerWithModal">Добавить удалить пользователя</a></li>
            ...
            <li class="navigatePage__element"><a href="#" data-page="messenger">Страница мессенджера</a></li>
